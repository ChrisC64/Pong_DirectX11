...
//TODO: Remove uses of DirectX::XMMATRIX and instead use DirectX::XMFLOAT4X4 instead.  
// This should remove the align warning being seen, as indicated by this SO post:http://stackoverflow.com/questions/20104815/warning-c4316-object-allocated-on-the-heap-may-not-be-aligned-16
// OR We could override the 'new' and 'delete' keywords, but I really don't want to do that. 
